...
RETURN_LEAVE_SITE_M = float(os.getenv("RETURN_LEAVE_SITE_M", "3600"))
...
# the order to "On site". 3219 m ≈ 2 miles — a wide radius, so the dwell time below
# is what actually keeps a truck merely passing nearby from tripping it.
JOB_GEOFENCE_M = float(os.getenv("JOB_GEOFENCE_M", "3219"))
